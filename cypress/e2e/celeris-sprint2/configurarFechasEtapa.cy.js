describe('57827 : Configurar fechas por etapas', ()=>{
    ...
    it('CP03_Validar el Comportamiento de listas desplegables y dependencias', () => {
        ...
        cy.get('[placeholder="Buscar..."]').click().type("AMAZONAS")
        ...
        cy.get('[placeholder="Buscar..."]').click().type("LETICIA")
        ...
        cy.get('[placeholder="Buscar..."]').click().type("ZONA 01")
        ...
        cy.get('[placeholder="Buscar..."]').click().type("JORGE ELIECER GAITAN")
        ...
        cy.get('[placeholder="Buscar..."]').click().type("MESA 1")
