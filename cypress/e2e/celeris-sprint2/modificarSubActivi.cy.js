describe('58379 : Modificación de sub - actividad para una actividad', () => {
    ...
    it('CP2_Validar estructura de la modal de editar sub-actividades',()=>{
        ...
        cy.get('.bg-white.block.border.border-gray-300.cursor-pointer.duration-300').eq(3).should('be.visible').and('have.prop','innerText','Seleccione una opción')
        cy.get('.bg-white.block.border.border-gray-300.cursor-pointer.duration-300').eq(4).should('be.visible').and('have.prop','innerText','Seleccione una opción')
