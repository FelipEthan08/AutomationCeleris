describe('62750 : Cargue de Archivo de Agrupaciones Políticas', () => {
    ...
    it('CP04_Validación del archivo de “Agrupaciones políticas" excede limite de tamaño 5MB', () => {
        cy.contains('Cargue de Archivo').click()
        cy.url().should('eq', 'https://celerisawsqa.tps.net.co/dashboard/basic-files/load-file');
        cy.wait(1000)
        cy.contains('button', ' Agrupaciones políticas ').click({force: true})
    ...
    it('CP05_Validación de cada uno de los campos del "Archivo Básico" publicado en el sistema', () => {
        cy.contains('Cargue de Archivo').click()
        cy.url().should('eq', 'https://celerisawsqa.tps.net.co/dashboard/basic-files/load-file');
        cy.wait(1000)
        cy.contains('button', ' Agrupaciones políticas ').click({force: true})
    ...
    it('CP06_Cargue exitoso de archivo válido', () => {
        cy.contains('Cargue de Archivo').click()
        cy.url().should('eq', 'https://celerisawsqa.tps.net.co/dashboard/basic-files/load-file');
        cy.wait(1000)
        cy.contains('button', ' Agrupaciones políticas ').click({force: true})
